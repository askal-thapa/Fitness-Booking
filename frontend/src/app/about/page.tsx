    ...
    <div className="min-h-screen bg-charcoal flex flex-col">
      ...
      <main className="max-w-4xl mx-auto px-6 py-32 flex-1 w-full space-y-12">
        <section className="space-y-6">
          <span className="text-muted-blue text-xs font-bold uppercase tracking-[0.3em] block">Our Story</span>
          <h1 className="text-5xl md:text-6xl font-bold text-white tracking-tighter italic font-serif">Redefining Performance.</h1>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12 border-t border-white/5">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-white tracking-tight">The Standard</h2>
            <p className="text-off-white/40 leading-relaxed">
